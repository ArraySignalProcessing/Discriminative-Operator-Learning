"""test_subspace_1E.py
Topic 1E - array-imperfection RMSE & PoR vs rho.
Read ../data/C3/C3_ArrayMismatch.h5 and write ../data/C3/C3_SubspaceNet.h5.
"""
...
OUT_PATH = '../data/C3/C3_SubspaceNet.h5'
K = 2
...
def parse_group(group_name: str) -> float:
    match = re.search(r'Rho_(\d+\.?\d*)', group_name)
...
with h5py.File(DATA_PATH, 'r') as f:
    ...
    for grp in groups:
        ...
        print(f'Rho={x_value:.3f}: RMSE={rmse:.3f} deg, PoR@{THRESHOLD:.1f}deg={por:.1f}%')
